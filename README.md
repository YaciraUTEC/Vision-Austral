...
|---------|-------|-----------|------------------|----------------------------------|-------------------------|
| **I. Preparación de Datos y Entorno** | 1.1 | Instalación Base | Instalar la librería de Ultralytics (YOLOv11) y Python. | `pip install ultralytics` | Librería YOLOv8 lista para usarse. |
...
| **II. Entrenamiento del Modelo YOLOv11** | 2.1 | Entrenamiento (Fine-Tuning) | Entrenar YOLOv8n preentrenado usando fine-tuning recomendado. | `yolo train model=yolov8n.pt data=anchovy.yaml epochs=100 imgsz=640 batch=8 freeze=10` | Archivo de pesos `best.pt` generado. |
